...
sealed class BottomNavItem(
    ...
    data object Wishlist : BottomNavItem("wishlist", "Wishlist", R.drawable.heart)
    data object Cart : BottomNavItem("cart", "Cart", R.drawable.cart)
    data object Search : BottomNavItem("search", "Search", R.drawable.search)
    data object Settings : BottomNavItem("settings", "Setting", R.drawable.settings)
}
